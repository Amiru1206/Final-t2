...
namespace FINAL__
{
    public partial class Listteachers_form : DevComponents.DotNetBar.Metro.MetroForm
    {
        public Listteachers_form()
        {
            InitializeComponent();
        }

        private void Listteachers_form_FormClosing(object sender, FormClosingEventArgs e)
        {
            e.Cancel = true;
            this.Hide();
        }
        private void Refresh()
        {
            ...
            comboBoxEx1.Text = comboBox1.Text  = comboBox3.Text = comboBox4.Text = "";
            try
            {
        ...
        private void Listteachers_form_Load(object sender, EventArgs e)
        {
            Refresh();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string query = "DELETE FROM Teachers WHERE Codemelli = '" + codemelli + "'";
                SqlConnection sc = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\Me\\Source\\Repos\\Final++\\FINAL++\\Database1.mdf;Integrated Security=True");
                sc.Open();
                //دوتا خط پایین توضیح؟
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string query = "SELECT * FROM Teachers WHERE Codemelli = '" + Codemelli + "'";
                SqlConnection sc = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\Me\\Source\\Repos\\Final++\\FINAL++\\Database1.mdf;Integrated Security=True");
                sc.Open();
                //دوتا خط پایین توضیح؟
                SqlCommand cmd = new SqlCommand(query, sc);
                ...
                comboBox1.Text = dr["Lesson"].ToString();
                ...
                if (textBoxX5.Text.Length == 4)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            string lesson = comboBox1.Text;
                            string query = "UPDATE Teachers SET codemelli=N'" + Codemelli + "'" +
                            ",name=N'" + name + "',Lname=N'" + lname + "'" +
                            ",Fname=N'" + fname + "',bdate=N'" + bdate + "',lesson=N'" + lesson + "'" +
                            ...
                            if (i > 0)
                            {
                                ...
                                comboBox1.Text = comboBox3.Text = comboBox4.Text = "";
                                Refresh();
                                button1.Enabled = true;
                                button2.Enabled = true;
                                button3.Enabled = true;
